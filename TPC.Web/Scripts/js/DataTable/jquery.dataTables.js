...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Filter" class="searchfilter ' + classes.sFilterInput + '"/><a id="ClearSearchBox" href="#" class="place-left SearchClose">X</a>';
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( ! scrollX )
		{
			divBodyStyle.width = '103%';
			divHeader[0].style.width = '102%';
		}
