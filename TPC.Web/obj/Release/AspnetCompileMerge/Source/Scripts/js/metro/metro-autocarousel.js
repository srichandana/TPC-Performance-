    ...
    $.widget("metro.carousel", {
        ...
        _slideTo: function(direction){
            ...
            if (direction === 'prior') {
                ...
                if (this._currentIndex == 0) carousel.find('.controls.left').hide();
                carousel.find('.controls.right').show();
                //
                ...
                carousel.find('.controls.left').show();
                if (this._currentIndex == this._slides.length - 1) carousel.find('.controls.right').hide();
                //
        ...
        _markers: function (that) {
            ...
            for (i = 0; i < this._slides.length; i++) {
                li = $('<li><a href="javascript:void(0)" data-num="' + i + '"><button type="button" style="border-radius: 100%; height: 15px; width: 15px;"></button></a></li>');
                if (i === 0) {
                    li.addClass('active');
                }
                li.appendTo(ul);
